...
// Mauritania
      ...
      const mauritania = document.querySelector('.mauritania');
      const mauritaniaRed = document.querySelector('.mauritania-red');
      const mauritaniaGreen = document.querySelector('.mauritania-green');
      const mauritaniaStar = document.querySelector('.mauritania-star');
      const mauritaniaMoon = document.querySelector('.mauritania-moon');

// Myanmar

      const myanmar = document.querySelector('.myanmar');
      const myanmarYellow = document.querySelector('.myanmar-yellow');
      const myanmarGreen = document.querySelector('.myanmar-green');
...
if (selectCountry.value === '4') {
  ...
  document.body.style.background = "url(img/italy/italy1.jpg)";
}
...
if (selectCountry.value === '5') {
  ...
  document.body.style.background = "url(img/ireland/ireland1.jpg)";
...
if (selectCountry.value === '6') {
  ...
  document.body.style.background = "url(img/nigeria/nigeria1.jpg)";
}
...
if (selectCountry.value === '7') {
  ...
  document.body.style.background = "url(img/russia/russia1.jpg)";
...
// if benin is selected - opacity

if (selectCountry.value === '25') {
  counter +=1;
  benin.style.opacity = "1";
  benin.style.zIndex = counter;
  beninGreen.style.backgroundColor = "rgb(34, 136, 72)";
  beninYellow.style.backgroundColor = "rgb(253, 218, 36)";
...
// if madagascar is selected - opacity

if (selectCountry.value === '29') {
  counter +=1;
  madagascar.style.opacity = "1";
  madagascar.style.zIndex = counter;
  madagascarGreen.style.backgroundColor = "rgb(0,132,61)";
  madagascarRed.style.backgroundColor = "rgb(249,66,58)";
...
// if mauritania is selected - opacity

if (selectCountry.value === '53') {
  counter +=1;
  mauritania.style.opacity = "1";
  mauritania.style.zIndex = counter;
  mauritaniaRed.style.backgroundColor = "rgb(208, 28, 31)";
  mauritaniaGreen.style.backgroundColor = "rgb(0, 169, 92)";
  mauritaniaStar.style.color = "rgb(255, 215, 0)";
  mauritaniaMoon.style.color = "rgb(255, 215, 0)";
}

// if myanmar is selected - opacity

if (selectCountry.value === '54') {
  counter +=1;
  myanmar.style.opacity = "1";
  myanmar.style.zIndex = counter;
  myanmarYellow.style.backgroundColor = "rgb(255, 205, 0)";
...
// if France is selected - change color
  ...
  if (selectCountry.value === '4') {
    ...
    document.body.style.background = `url(img/italy/italy${randomNumPic()}.jpg`;
  }
  ...
  if (selectCountry.value === '6') {
    ...
    document.body.style.background = `url(img/nigeria/nigeria${randomNumPic()}.jpg`;
  }
  ...
  if (selectCountry.value === '7') {
    ...
    document.body.style.background = `url(img/russia/russia${randomNumPic()}.jpg`;
  }
  ...
  // if Benin is selected - change color
  ...
  // if Madagascar is selected - change color
...
// if Mauritania is selected - change color

if (selectCountry.value === '53') {

  mauritaniaRed.style.backgroundColor = 'rgb(' + randomNum() + ',' + randomNum() + ',' + randomNum() + ')';
  mauritaniaGreen.style.backgroundColor = 'rgb(' + randomNum() + ',' + randomNum() + ',' + randomNum() + ')';
  mauritaniaStar.style.color = 'rgb(' + randomNum() + ',' + randomNum() + ',' + randomNum() + ')';
  mauritaniaMoon.style.color = 'rgb(' + randomNum() + ',' + randomNum() + ',' + randomNum() + ')';
}

// if Myanmar is selected - change color

if (selectCountry.value === '54') {

  myanmarYellow.style.backgroundColor = 'rgb(' + randomNum() + ',' + randomNum() + ',' + randomNum() + ')';
